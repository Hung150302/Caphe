...
public abstract class ItemContactBinding extends ViewDataBinding {
  ...
  @Bindable
  protected Contact mContactModel;

  protected ItemContactBinding(Object _bindingComponent, View _root, int _localFieldCount,
      CircleImageView imgContact, LinearLayout layoutItem, TextView tvContact) {
  ...
  public abstract void setContactModel(@Nullable Contact ContactModel);
